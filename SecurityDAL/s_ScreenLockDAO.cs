...
namespace SecurityDAL
{
	public class s_ScreenLockDAO //: IDisposible
	{
		...
		public List<s_ScreenLock> GetByUserAndScreen(Int32 UserId, Int32 ScreenId)
		{
			try
			{
				List<s_ScreenLock> s_ScreenLockLst = new List<s_ScreenLock>();
				...
				s_ScreenLockLst = dbExecutor.FetchData<s_ScreenLock>(CommandType.StoredProcedure, "s_ScreenLock_Get", colparameters);
		...
		public int Add(s_ScreenLock s_ScreenLock)
		{
			...
			try
			{
				...
				ret = dbExecutor.ExecuteScalar32(true, CommandType.StoredProcedure, "s_ScreenLock_Create", colparameters, true);
        ...
        public int UnLockAll(Int32 UserId)
		{
			...
			try
			{
                ...
                ret = dbExecutor.ExecuteNonQuery(CommandType.StoredProcedure, "s_ScreenLock_UnLockAll", colparameters, true);
			return ret;
			}
			catch (Exception ex)
			{
		...
		public int Delete(Int64 ScreenLockId)
		{
			try
			{
				...
				ret = dbExecutor.ExecuteNonQuery(CommandType.StoredProcedure, "s_ScreenLock_DeleteById", colparameters, true);
				return ret;
			}
			catch (Exception ex)
			{
