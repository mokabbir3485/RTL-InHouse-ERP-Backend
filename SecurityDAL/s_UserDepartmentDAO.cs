	...
	public class s_UserDepartmentDAO //: IDisposible
	{
		...
		public List<s_UserDepartment> GetByUserId(Int32 userId)
		{
			try
			{
                ...
                s_UserDepartmentLst = dbExecutor.FetchData<s_UserDepartment>(CommandType.StoredProcedure, "s_UserDepartment_GetByUserId", colparameters);
        ...
        public List<s_UserDepartment> GetAllUserStore(Int32 userId)
        {
            try
            {
                ...
                s_UserDepartmentLst = dbExecutor.FetchData<s_UserDepartment>(CommandType.StoredProcedure, "s_UserDepartment_GetAllUserStore", colparameters);
                return s_UserDepartmentLst;
            }
            catch (Exception ex)
            {
		...
		public List<s_UserDepartment> GetDynamic(string whereCondition,string orderByExpression)
		{
			try
			{
				...
				s_UserDepartmentLst = dbExecutor.FetchData<s_UserDepartment>(CommandType.StoredProcedure, "s_UserDepartment_GetDynamic", colparameters);
				return s_UserDepartmentLst;
			}
			catch (Exception ex)
			{
		...
		public int Add(s_UserDepartment _s_UserDepartment)
		{
			...
			try
			{
				...
				new Parameters("@DepartmentId", _s_UserDepartment.DepartmentId, DbType.Int32, ParameterDirection.Input)
				};
				dbExecutor.ManageTransaction(TransactionType.Open);
				ret = dbExecutor.ExecuteScalar32(true, CommandType.StoredProcedure, "s_UserDepartment_Create", colparameters, true);
		...
		public int Update(s_UserDepartment _s_UserDepartment)
		{
			...
			try
			{
				...
				new Parameters("@UserDepartmentId", _s_UserDepartment.UserDepartmentId, DbType.Int32, ParameterDirection.Input),
				new Parameters("@UserId", _s_UserDepartment.UserId, DbType.Int32, ParameterDirection.Input),
				new Parameters("@DepartmentId", _s_UserDepartment.DepartmentId, DbType.Int32, ParameterDirection.Input)
				};
				ret = dbExecutor.ExecuteNonQuery(CommandType.StoredProcedure, "s_UserDepartment_Update", colparameters, true);
			return ret;
			}
			catch (Exception ex)
			{
		...
		public int Delete(Int32 userDepartmentId)
		{
			try
			{
				...
				ret = dbExecutor.ExecuteNonQuery(CommandType.StoredProcedure, "s_UserDepartment_DeleteById", colparameters, true);
				return ret;
			}
			catch (Exception ex)
			{
