...
namespace InventoryDAL
{
	public class inv_PurchaseBillDetailAdAttributeDAO //: IDisposible
	{
        ...
        public List<inv_PurchaseBillDetailAdAttribute> GetByPBDetailId(Int64 pBDetailId)
        {
            try
            {
                List<inv_PurchaseBillDetailAdAttribute> inv_PurchaseBillDetailAdAttributeLst = new List<inv_PurchaseBillDetailAdAttribute>();
                ...
                inv_PurchaseBillDetailAdAttributeLst = dbExecutor.FetchData<inv_PurchaseBillDetailAdAttribute>(CommandType.StoredProcedure, "inv_PurchaseBillDetailAdAttribute_GetByPBDetailId", colparameters);
                return inv_PurchaseBillDetailAdAttributeLst;
            }
            catch (Exception ex)
            {
		...
		public int Add(inv_PurchaseBillDetailAdAttribute _inv_PurchaseBillDetailAdAttribute)
		{
			...
			try
			{
				...
				new Parameters("@AttributeQty", _inv_PurchaseBillDetailAdAttribute.AttributeQty, DbType.Decimal, ParameterDirection.Input)
				};
